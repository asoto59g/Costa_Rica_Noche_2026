...
//title
var titleControl = document.createElement('div');
titleControl.style.position = 'absolute';
titleControl.style.top = '10px';
titleControl.style.left = '50%';
titleControl.style.transform = 'translateX(-50%)';
titleControl.style.zIndex = '1000';
titleControl.innerHTML = '<div style="font-family: \'Segoe UI\', Tahoma, Geneva, Verdana, sans-serif; font-weight: bold; font-size: 18px; padding: 10px 20px; background-color: rgba(255, 255, 255, 0.9); border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.3); pointer-events: auto; white-space: nowrap;">Costa Rica Night Lights 2026</div>';
document.getElementById('map').appendChild(titleControl);
...
var layerSwitcherControl = document.getElementsByClassName('layer-switcher')[0] || document.getElementsByClassName('ol-layerswitcher')[0];
